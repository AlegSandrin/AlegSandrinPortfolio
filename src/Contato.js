...
<div className="Contato h-full bg-gray-700 p-6 lg:p-10" id="contato">
    ...
    <h1 className='text-center text-purple-300 lg:text-6xl md:text-5xl text-4xl mb-8 mx-auto'>Entre em contato comigo!</h1>
    </div>
    <div className=' bg-gray-800 h-[80%] w-[98%] lg:h-[600px] lg:w-[900px] mx-auto shadow-2xl opacity-95 p-8 z-20 rounded-3xl'>
    ...
    <form className='w-full h-full flex flex-col lg:grid grid-cols-1 lg:grid-cols-2 gap-4 border-blue-500' ref={form} onSubmit={sendEmail}>
        ...
        <div className='md:col-span-2 md:flex grid grid-cols-3 h-[50px] lg:-mb-8 translate-y-[10px] lg:translate-y-0 bottom-0 gap-5 md:w-auto w-[50%] md:gap-10 float-left lg:mx-auto'>
