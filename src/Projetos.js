...
function ProjetosListar(){
    ...
    for(var i = 0; i < len; i++){ 
        ...
        lista.push(
            <>
                <div className="bg-gray-600 relative flex flex-grow rounded-3xl pr-10 h-40 sm:h-40 md:h-40 lg:h-52 xl:h-60">
...
function Projetos(){
    ...
    return(
        <div className="Projetos min-h-screen bg-gray-700 p-6 lg:p-10">

            <div className="min-h-screen">
                <h1 className="text-indigo-300 text-left text-4xl sm:text-5xl m-5 "> Projetos </h1>

                <div className="min-h-screen bg-gray-800 rounded-3xl shadow-2xl opacity-90 p-8">
